...
opt=contset(opt,'MaxNumPoints',1000000);
...
lamdaee=4; lamdasle=0.3; lamdase=0.25; lamdaemz=1; lamdaws=6; lamdawmsl=0.5; lamdaww=0.4;
...
% initial condition
x_start = [33554.833280 56.5 0 0 0 0 0 0 0];

%calculating steady state for given initial condition 
[t,x_time] = ode15s(@(t,kmrgd)handles{2}(t,kmrgd,I,lamdazu200,nzu200,z0u200,nu200,u2000,lamdasu200,nsu200,s0u200,lamdazmz,nzmz,z0mz,lamdasmz,nsmz,s0mz,lamdaslu200,sl0u200,nslu200,lamdaslmsl,nslmsl,sl0msl,lamdasmsl,nsmsl,s0msl,lamdasls,nsls,sl0s,lamdass,nss,s0s,lamdaIs,I0s,nIs,gu200,ku200,gmz,kmz,gz,kz,gmsl,kmsl,gs,ks,gsl,ksl,k0msl,lamdakmsl,nkmsl,k0s,lamdaks,nks,s0k,lamdask,nsk,sl0k,lamdaslk,nslk,gk,kk,lamdakk,nkk,k0k,ge,ke,lamdaee,e0e,nee,lamdasle,sl0e,nsle,lamdase,s0e,nse,lamdaemz,e0mz,nemz,lamdaws,w0s,nws,lamdawmsl,w0msl,nwmsl,lamdaww,w0w,nww,gw,kw),tspan,x_start);
x_init = x_time(end,:)';

%drawing bifurcation using a continuation method
[x0,v0] = init_EP_EP(@WT1,x_init,[I,lamdazu200,nzu200,z0u200,nu200,u2000,lamdasu200,nsu200,s0u200,lamdazmz,nzmz,z0mz,lamdasmz,nsmz,s0mz,lamdaslu200,sl0u200,nslu200,lamdaslmsl,nslmsl,sl0msl,lamdasmsl,nsmsl,s0msl,lamdasls,nsls,sl0s,lamdass,nss,s0s,lamdaIs,I0s,nIs,gu200,ku200,gmz,kmz,gz,kz,gmsl,kmsl,gs,ks,gsl,ksl,k0msl,lamdakmsl,nkmsl,k0s,lamdaks,nks,s0k,lamdask,nsk,sl0k,lamdaslk,nslk,gk,kk,lamdakk,nkk,k0k,ge,ke,lamdaee,e0e,nee,lamdasle,sl0e,nsle,lamdase,s0e,nse,lamdaemz,e0mz,nemz,lamdaws,w0s,nws,lamdawmsl,w0msl,nwmsl,lamdaww,w0w,nww,gw,kw],ap);
